...
# template
doc = DocxTemplate("memoria-cálculos-estribo-superficial.docx")
...
def design(params):
    ...
    fc_superestructura = params['fc_superestructura'] = params.get(
        'fc_superestructura', 28)

    E_acero = params['E_acero'] = params.get('E_acero', 200000)

    fy = params['fy'] = params.get('fy', 420)

    numero_carriles = params['numero_carriles'] = params.get(
        'numero_carriles', 1)
    ...
    pesoespecifico_concreto = params['pesoespecifico_concreto'] = params.get(
        'pesoespecifico_concreto', 23.544)

    pesoespecifico_carpetaasfaltica = params['pesoespecifico_carpetaasfaltica'] = params.get(
        'pesoespecifico_carpetaasfaltica', 21.582)
    ...
    pesoespecifico_suelo = params['pesoespecifico_suelo'] = params.get(
        'pesoespecifico_suelo', 19.61)

    capacidaddecarganominaldelsuelo = params['capacidaddecarganominaldelsuelo'] = params.get(
        'capacidaddecarganominaldelsuelo', 1)

    angulodefriccioninternadelsuelodecimentacion = params['angulodefriccioninternadelsuelodecimentacion'] = params.get(
        'angulodefriccioninternadelsuelodecimentacion', 30)
    ...
    factorderesistencia = params['factorderesistencia'] = params.get(
        'factorderesistencia', 0.45)

    capacidadportantemayoradadelsuelo = params['capacidadportantemayoradadelsuelo'] = factorderesistencia * \
        capacidaddecarganominaldelsuelo

    factorderesistencia_servicio = params['factorderesistencia_servicio'] = params.get(
        'factorderesistencia_servicio', 0.65)

    capacidadportantemayoradadelsuelo_servicio = params[
        'capacidadportantemayoradadelsuelo_servicio'] = factorderesistencia_servicio * capacidaddecarganominaldelsuelo

    factorderesistencia_eventoextremo = params['factorderesistencia_eventoextremo'] = params.get(
        'factorderesistencia_eventoextremo', 0.8)

    capacidadportantemayoradadelsuelo_eventoextremo = params[
        'capacidadportantemayoradadelsuelo_eventoextremo'] = factorderesistencia_eventoextremo * capacidaddecarganominaldelsuelo
    ...
    municipio = params['municipio'] = params.get('municipio', 'Armenia')

    departamento = params['departamento'] = params.get(
    ...
    # Vastago
    altura_vastago = params['altura_vastago'] = params.get(
        'altura_vastago', 1.15)
    espesor_vastago = params['espesor_vastago'] = params.get(
        'espesor_vastago', 0.5)
    ...
    # Espaldar
    altura_espaldar = params['altura_espaldar'] = params.get(
        'altura_espaldar', 1.35)
    espesor_espaldar = params['espesor_espaldar'] = params.get(
        'espesor_espaldar', 0.25)
    distanciaalabase_espaldar = params['distanciaalabase_espaldar'] = params.get(
        'distanciaalabase_espaldar', 1.35)
    ...
    cantidad_aletas = params['cantidad_aletas'] = params.get(
        'cantidad_aletas', 2)
    ...
    espesor_base_aletas = params['espesor_base_aletas'] = params.get(
        'espesor_base_aletas', 0.25)
    espesor_corona_aletas = params['espesor_corona_aletas'] = params.get(
        'espesor_corona_aletas', 0.25)
    ...
    L_superestructura = params['L_superestructura'] = params.get(
        'L_superestructura', 28)
    ...
    # Carpeta asfaltica
    ancho_carpetaasfaltica = params['ancho_carpetaasfaltica'] = params.get(
        'ancho_carpetaasfaltica', 6)

    espesor_carpetaasfaltica = params['espesor_carpetaasfaltica'] = params.get(
        'espesor_carpetaasfaltica', 0.1)
    ...
    DC_vigas = params['DC_vigas'] = round(
        cantidad_vigas * peso_vigas * L_superestructura/2, 2)

    DC_sobreimpuestas = params['DC_sobreimpuestas'] = round(
        (peso_anden + peso_bordillo) * L_superestructura/2 + peso_barandas * L_superestructura/2, 2)

    DW = params['DW'] = round(ancho_carpetaasfaltica * espesor_carpetaasfaltica *
                              pesoespecifico_carpetaasfaltica * L_superestructura/2, 2)
    ...
    DC_total_superestructura = params['DC_total_superestructura'] = DC_losa + \
        DC_sobreimpuestas + DC_vigas
    DC_total_superestructura_m = params['DC_total_superestructura_m'] = round(
        DC_total_superestructura / largo_estribo, 2)

    X_a = params['X_a'] = round(ancho_base - (espesor_vastago / 2), 2)
    M_a_DC = params['M_a_DC'] = round(
        DC_total_superestructura / largo_estribo * X_a, 2)
    ...
    carga_total_camion = params['carga_total_camion'] = carga_primereje_camion + \
        carga_segundoeje_camion + carga_tercereje_camion
    ...
    cargatotal_tandem = params['cargatotal_tandem'] = carga_primereje_tandem + \
        carga_segundoeje_tandem

    # Carril de diseño
    carga_carrildiseño = params['carga_carrildiseño'] = 10.3

    carga_camion_estribo = params['carga_camión_estribo'] = carga_primereje_camion * 1 + carga_segundoeje_camion * (
        1 - distancia_ejes1y2_camion / L_superestructura) + carga_tercereje_camion * (1 - (distancia_ejes1y2_camion + distancia_ejes2y3_camion)/L_superestructura)
    carga_tandem_estribo = params['carga_tandem_estribo'] = carga_primereje_tandem * \
        1 + carga_segundoeje_tandem * \
        (1 - distancia_ejes1y2_tandem / L_superestructura)
    carga_carrildiseño_estribo = params['carga_carrildiseño_estribo'] = carga_carrildiseño * \
        L_superestructura / 2 * 1
    ...
    if carga_camion_estribo > carga_tandem_estribo:
        carga_vehicular_uncarril = round(
            factor_cargadinamica * carga_camion_estribo + carga_carrildiseño_estribo, 2)
    else:
        carga_vehicular_uncarril = round(
            factor_cargadinamica * carga_tandem_estribo + carga_carrildiseño_estribo, 2)

    params['carga_vehicular_uncarril'] = carga_vehicular_uncarril

    carga_vehicular_doscarriles = params['carga_vehicular_doscarriles'] = round(
        numero_carriles * carga_vehicular_uncarril, 2)

    carga_vehicular_por_m_ancho_estribo = params['carga_vehicular_por_m_ancho_estribo'] = round(
        carga_vehicular_doscarriles / largo_estribo, 2)

    # Momento de estabilización con respecto al punto A debido a la carga vehicular de diseño
    M_a_LLIM = params['M_a_LLIM'] = round(
        carga_vehicular_por_m_ancho_estribo * X_a, 2)
    ...
    BR_25 = params['BR_25'] = numero_carriles * \
        factor_presenciamultiple * 0.25 * carga_total_camion
    BR_5 = params['BR_5'] = 0.05 * numero_carriles * factor_presenciamultiple * \
        (carga_total_camion + carga_carrildiseño * L_superestructura/2)
    if BR_25 > BR_5:
    ...
    # Peso del estribo
    DC_zapata = pesoespecifico_concreto * \
        (ancho_base + ancho_talon) * ((altura_base + altura_talon) / 2)
    ...
    Y_a_espaldar = ((altura_base + altura_talon) / 2) + \
        distanciaalabase_espaldar + altura_espaldar / 2
    ...
    DC_topes = (pesoespecifico_concreto * cantidad_topes *
                altura_topes * ancho_topes * largo_topes) / largo_estribo
    X_a_topes = ancho_base - ancho_topes / 2
    Y_a_topes = ((altura_base + altura_talon) / 2) + \
        altura_vastago + altura_topes / 2
    ...
    DC_aletas = pesoespecifico_concreto * cantidad_aletas * \
        (altura_aletas * ancho_aletas - espesor_espaldar * altura_espaldar) * \
        ((espesor_base_aletas + espesor_corona_aletas)/2) / largo_estribo
    X_a_aletas = (ancho_estribo - (ancho_talon-espesor_espaldar)/2)
    Y_a_aletas = ((altura_aletas * espesor_corona_aletas * (altura_aletas / 2 + altura_base)) + (0.5 * altura_aletas * (espesor_base_aletas - espesor_corona_aletas)
                  * (altura_aletas/3 + altura_base))) / ((altura_aletas * espesor_corona_aletas) + 0.5 * altura_aletas * (espesor_base_aletas - espesor_corona_aletas))
    ...
    suma_DC_X_a = DC_X_a_zapata + DC_X_a_vastago + \
        DC_X_a_espaldar + DC_X_a_topes + DC_X_a_aletas
    params['suma_DC_X_a'] = round(suma_DC_X_a, 2)

    suma_DC_Y_a = DC_Y_a_zapata + DC_Y_a_vastago + \
        DC_Y_a_espaldar + DC_Y_a_topes + DC_Y_a_aletas
    ...
    DC_relleno = pesoespecifico_suelo * \
        (altura_aletas * ancho_aletas - espesor_espaldar * altura_espaldar)
    ...
    coeficiente_presion_lateral_suelo = params['coeficiente_presion_lateral_suelo'] = (
        1-math.sin(angulodefriccioninternadelsuelodecimentacion/180*math.pi)) / (1+math.sin(angulodefriccioninternadelsuelodecimentacion/180*math.pi))
    if altura_estribo <= 3:
    ...
    presion_horizontal_suelo_sobrecargaviva = params['presion_horizontal_suelo_sobrecargaviva'] = round(
        coeficiente_presion_lateral_suelo * pesoespecifico_suelo * altura_equivalente_suelo, 2)
    ...
    L_S_x = params['L_S_x'] = round(
        presion_horizontal_suelo_sobrecargaviva * altura_estribo, 2)
    ...
    L_S_y = params['L_S_y'] = round(
        presion_horizontal_suelo_sobrecargaviva * (ancho_talon - espesor_espaldar), 2)
    Y_a_LS = params['Y_a_LS'] = round(
        (ancho_estribo - (ancho_talon - espesor_espaldar) / 2), 2)
    ...
    suma_cargas_verticales_estribo = params['suma_cargas_verticales_estribo'] = round(
        DC_total_superestructura_m + DC_total_estribo + DW_m + DC_relleno + carga_vehicular_por_m_ancho_estribo + L_S_y, 2)
    suma_M_a_estribo = params['suma_M_a_estribo'] = round(
        suma_DC_X_a + M_a_DC + M_a_DW + DC_X_a_relleno + M_a_LLIM + M_a_LS_y, 2)
    ...
    coeficiente_presion_activa_suelo = params['coeficiente_presion_activa_suelo'] = round(
        (1-math.sin(angulodefriccioninternadelsuelodecimentacion/180*math.pi)) / (1+math.sin(angulodefriccioninternadelsuelodecimentacion/180*math.pi)), 3)
    empuje_activo_estatico_EH = params['empuje_activo_estatico_EH'] = round(
        pesoespecifico_suelo * coeficiente_presion_activa_suelo * altura_estribo ** 2 / 2, 2)
    ...
    theta_Mo = params['theta_Mo'] = round(
        math.atan(k_h/(1-kv)) * 180 / math.pi, 2)

    K_AE = params['K_AE'] = round((math.cos((angulodefriccioninternadelsuelodecimentacion-theta_Mo-beta_estribo) * math.pi / 180)) ** 2 / ((math.cos(theta_Mo / 180 * math.pi)) * (math.cos(beta_estribo * math.pi / 180)) ** 2 * math.cos((delta_estribo + beta_estribo + theta_Mo)/180 * math.pi)) * (1 + math.sqrt(
        (math.sin((angulodefriccioninternadelsuelodecimentacion + delta_estribo)/180*math.pi)*math.sin((angulodefriccioninternadelsuelodecimentacion - theta_Mo - i_estribo)/180 * math.pi))/(math.cos((delta_estribo + beta_estribo + theta_Mo)/180*math.pi)*math.cos((i_estribo - beta_estribo)/180*math.pi))))**-2, 3)
    P_AE = params['P_AE'] = round(
        0.5 * K_AE * pesoespecifico_suelo * altura_estribo ** 2, 2)
    delta_P_AE = params['delta_P_AE'] = round(
        P_AE - empuje_activo_estatico_EH, 2)
    distancia_aplicacion_deltaP_AE = params['distancia_aplicacion_deltaP_AE'] = round(
        0.4 * altura_estribo, 2)
    M_a_delta_P_AE = params['M_a_delta_P_AE'] = round(
        delta_P_AE * distancia_aplicacion_deltaP_AE, 2)
    ...
    Pseis_2 = params['Pseis_2'] = round(
        0.5 * empuje_activo_estatico_EH + P_IR, 2)

    if Pseis_1 > Pseis_2:
        Pseis_e = Pseis_1
    else:
        Pseis_e = Pseis_2
    M_a_p_seis = params['M_a_p_seis'] = round(
        distancia_aplicacion_deltaP_AE * Pseis_e, 2)
    ...
    coeficiente_friccion = params['coeficiente_friccion'] = params.get(
        'coeficiente_friccion', 0.2)
    P_u = params['P_u'] = round(1.25 * DC_total_superestructura_m +
                                1.5 * DW_m + 0.5 * carga_vehicular_por_m_ancho_estribo, 2)
    Hbu = params['Hbu'] = round(coeficiente_friccion * P_u, 2)
    distancia_aplicacion_Hbu = params['distancia_aplicacion_Hbu'] = round(
        altura_base + altura_vastago, 2)
    M_a_Hbu = params['M_a_Hbu'] = round(distancia_aplicacion_Hbu * Hbu, 2)

    suma_fuerzas_sismicas = params['suma_fuerzas_sismicas'] = round(
        Pseis_e + Hbu, 2)
    suma_M_a_fuerzas_sismicas = params['suma_M_a_fuerzas_sismicas'] = round(
        M_a_p_seis + M_a_Hbu, 2)

    # Longitud de apoyo

    S_angulo_sesgo = params['S_angulo_sesgo'] = params.get('S_angulo_sesgo', 0)
    altura_columnas = params['altura_columnas'] = params.get(
        'altura_columnas', 0)
    mayoración_N = params['mayoracion_N'] = params.get('mayoracion_N', 1.5)
    longitud_apoyo = params['longitud_apoyo'] = round(
        mayoración_N * ((200 + 0.0017 * L_superestructura * 1000 + 0.0067 * altura_columnas * 1000) + (1 + 0.000125 * (S_angulo_sesgo * 1000) ** 2))/1000, 2)
    ...
    factor_carga_DC_max = params['factor_carga_DC_max'] = params.get(
        'factor_carga_DC_max', 1.25)
    factor_carga_DC_min = params['factor_carga_DC_min'] = params.get(
        'factor_carga_DC_min', 0.9)
    factor_carga_DW_max = params['factor_carga_DW_max'] = params.get(
        'factor_carga_DW_max', 1.5)
    factor_carga_DW_min = params['factor_carga_DW_min'] = params.get(
        'factor_carga_DW_min', 0.65)
    factor_carga_EH_max = params['factor_carga_EH_max'] = params.get(
        'factor_carga_EH_max', 1.5)
    factor_carga_EH_min = params['factor_carga_EH_min'] = params.get(
        'factor_carga_EH_min', 0.9)
    factor_carga_EV_eg_max = params['factor_carga_EV_max'] = params.get(
        'factor_carga_EV_max', 1)
    factor_carga_EV_eg_min = params['factor_carga_EV_min'] = params.get(
        'factor_carga_EV_min', 0)
    factor_carga_EV_MyE_max = params['factor_carga_EV_MyE_max'] = params.get(
        'factor_carga_EV_MyE_max', 1.35)
    factor_carga_EV_MyE_min = params['factor_carga_EV_MyE_min'] = params.get(
        'factor_carga_EV_MyE_min', 1)
    factor_carga_ES_max = params['factor_carga_ES_max'] = params.get(
        'factor_carga_ES_max', 1.5)
    factor_carga_ES_min = params['factor_carga_ES_min'] = params.get(
        'factor_carga_ES_min', 0.75)
    factor_carga_EQ_max = params['factor_carga_EQ_max'] = params.get(
        'factor_carga_EQ_max', 1)
    factor_carga_EQ_min = params['factor_carga_EQ_min'] = params.get(
        'factor_carga_EQ_min', 1)
    factor_carga_LS_max = params['factor_carga_LS_max'] = params.get(
        'factor_carga_LS_max', 1.75)
    factor_carga_LS_min = params['factor_carga_LS_min'] = params.get(
        'factor_carga_LS_min', 0)
    factor_carga_LS_EE_max = params['factor_carga_LS_EE_max'] = params.get(
        'factor_carga_LS_EE_max', 0.5)
    factor_carga_LS_EE_min = params['factor_carga_LS_EE_min'] = params.get(
        'factor_carga_LS_EE_min', 0)

    fuerza_max_vertical_resistencia = params['fuerza_max_vertical_resistencia'] = round(factor_carga_DC_max * DC_total_superestructura_m + factor_carga_DC_max * DC_total_estribo +
                                                                                        factor_carga_DW_max * DW_m + factor_carga_EV_MyE_max * DC_relleno + factor_carga_LS_max * carga_vehicular_por_m_ancho_estribo + factor_carga_LS_max * L_S_y, 2)
    fuerza_min_vertical_resistencia = params['fuerza_min_vertical_resistencia'] = round(factor_carga_DC_min * DC_total_superestructura_m + factor_carga_DC_min * DC_total_estribo +
                                                                                        factor_carga_DW_min * DW_m + factor_carga_EV_MyE_min * DC_relleno + factor_carga_LS_min * carga_vehicular_por_m_ancho_estribo + factor_carga_LS_min * L_S_y, 2)
    fuerza_max_vertical_eventoextremo = params['fuerza_max_vertical_eventoextremo'] = round(factor_carga_DC_max * DC_total_superestructura_m + factor_carga_DC_max * DC_total_estribo +
                                                                                            factor_carga_DW_max * DW_m + factor_carga_EV_MyE_max * DC_relleno + factor_carga_LS_EE_max * carga_vehicular_por_m_ancho_estribo + factor_carga_LS_EE_max * L_S_y, 2)
    fuerza_min_vertical_eventoextremo = params['fuerza_min_vertical_eventoextremo'] = round(factor_carga_DC_min * DC_total_superestructura_m + factor_carga_DC_min * DC_total_estribo +
                                                                                            factor_carga_DW_min * DW_m + factor_carga_EV_MyE_min * DC_relleno + factor_carga_LS_EE_min * carga_vehicular_por_m_ancho_estribo + factor_carga_LS_EE_min * L_S_y, 2)
    fuerza_vertical_servicio = params['fuerza_vertical_servicio'] = round(
        DC_total_superestructura_m + DC_total_estribo + DW_m + DC_relleno + carga_vehicular_por_m_ancho_estribo + L_S_y, 2)

    momento_max_vertical_resistencia = params['momento_max_vertical_resistencia'] = round(
        factor_carga_DC_max * M_a_DC + factor_carga_DC_max * suma_DC_X_a + factor_carga_DW_max * M_a_DW + factor_carga_EV_MyE_max * DC_X_a_relleno + factor_carga_LS_max * M_a_LLIM + factor_carga_LS_max * M_a_LS_y, 2)
    momento_min_vertical_resistencia = params['momento_min_vertical_resistencia'] = round(
        factor_carga_DC_min * M_a_DC + factor_carga_DC_min * suma_DC_X_a + factor_carga_DW_min * M_a_DW + factor_carga_EV_MyE_min * DC_X_a_relleno + factor_carga_LS_min * M_a_LLIM + factor_carga_LS_min * M_a_LS_y, 2)
    momento_max_vertical_eventoextremo = params['momento_max_vertical_eventoextremo'] = round(
        factor_carga_DC_max * M_a_DC + factor_carga_DC_max * suma_DC_X_a + factor_carga_DW_max * M_a_DW + factor_carga_EV_MyE_max * DC_X_a_relleno + factor_carga_LS_EE_max * M_a_LLIM + factor_carga_LS_EE_max * M_a_LS_y, 2)
    momento_min_vertical_eventoextremo = params['momento_min_vertical_eventoextremo'] = round(
        factor_carga_DC_min * M_a_DC + factor_carga_DC_min * suma_DC_X_a + factor_carga_DW_min * M_a_DW + factor_carga_EV_MyE_min * DC_X_a_relleno + factor_carga_LS_EE_min * M_a_LLIM + factor_carga_LS_EE_min * M_a_LS_y, 2)
    momento_vertical_servicio = params['momento_vertical_servicio'] = round(
        M_a_DC + suma_DC_X_a + M_a_DW + DC_X_a_relleno + M_a_LLIM + M_a_LS_y, 2)

    fuerza_max_horizontal_resistencia = params['fuerza_max_horizontal_resistencia'] = round(
        factor_carga_EH_max * empuje_activo_estatico_EH + factor_carga_LS_max * (L_S_x + BR_m_ancho), 2)
    fuerza_min_horizontal_resistencia = params['fuerza_min_horizontal_resistencia'] = round(
        factor_carga_EH_min * empuje_activo_estatico_EH + factor_carga_LS_min * (L_S_x + BR_m_ancho), 2)
    fuerza_max_horizontal_eventoextremo = params['fuerza_max_horizontal_eventoextremo'] = round(
        factor_carga_EH_max * empuje_activo_estatico_EH + factor_carga_LS_EE_max * (L_S_x + BR_m_ancho) + factor_carga_EQ_max * Pseis_e + factor_carga_EQ_max * Hbu, 2)
    fuerza_min_horizontal_eventoextremo = params['fuerza_min_horizontal_eventoextremo'] = round(
        factor_carga_EH_min * empuje_activo_estatico_EH + factor_carga_LS_EE_min * (L_S_x + BR_m_ancho) + factor_carga_EQ_min * Pseis_e + factor_carga_EQ_min * Hbu, 2)
    fuerza_horizontal_servicio = params['fuerza_horizontal_servicio'] = round(
        empuje_activo_estatico_EH + L_S_x + BR_m_ancho, 2)

    momento_max_horizontal_resistencia = params['momento_max_horizontal_resistencia'] = round(
        factor_carga_EH_max * M_a_EH + factor_carga_LS_max * (M_a_LS_x + M_a_BR), 2)
    momento_min_horizontal_resistencia = params['momento_min_horizontal_resistencia'] = round(
        factor_carga_EH_min * M_a_EH + factor_carga_LS_min * (M_a_LS_x + M_a_BR), 2)
    momento_max_horizontal_eventoextremo = params['momento_max_horizontal_eventoextremo'] = round(
        factor_carga_EH_max * M_a_EH + factor_carga_LS_EE_max * (M_a_LS_x+M_a_BR) + factor_carga_EQ_max * M_a_p_seis + factor_carga_EQ_max * M_a_Hbu, 2)
    momento_min_horizontal_eventoextremo = params['momento_min_horizontal_eventoextremo'] = round(
        factor_carga_EH_min * M_a_EH + factor_carga_LS_EE_min * (M_a_LS_x+M_a_BR) + factor_carga_EQ_min * M_a_p_seis + factor_carga_EQ_min * M_a_Hbu, 2)
    momento_horizontal_servicio = params['momento_horizontal_servicio'] = round(
        M_a_EH + M_a_LS_x + M_a_BR, 2)
    ...
    d_max_resistencia = params['d_max_resistencia'] = round(
        (momento_max_vertical_resistencia - momento_max_horizontal_resistencia)/fuerza_max_vertical_resistencia, 2)
    e_max_resistencia = params['e_max_resistencia'] = round(
        ancho_estribo / 2 - d_max_resistencia, 2)
    ...
    d_min_resistencia = params['d_min_resistencia'] = round(
        (momento_min_vertical_resistencia - momento_min_horizontal_resistencia)/fuerza_min_vertical_resistencia, 2)
    e_min_resistencia = params['e_min_resistencia'] = round(
        ancho_estribo / 2 - d_min_resistencia, 2)

    if math.fabs(e_min_resistencia) > e_limite_resistencia:
        print('no cumple verificación al volcamiento, estado límite resistencia')

    d_max_eventoextremo = params['d_max_eventoextremo'] = round(
        (momento_max_vertical_eventoextremo - momento_max_horizontal_eventoextremo)/fuerza_max_vertical_eventoextremo, 2)
    e_max_eventoextremo = params['e_max_eventoextremo'] = round(
        ancho_estribo / 2 - d_max_eventoextremo, 2)
    ...
    if factor_carga_LS_EE_max == 0:
        ...
        e_limite_eventoextremo = ancho_estribo/3 + \
            (ancho_estribo/15 * factor_carga_LS_EE_max)
    ...
    d_min_eventoextremo = params['d_min_eventoextremo'] = round(
        (momento_min_vertical_eventoextremo - momento_min_horizontal_eventoextremo)/fuerza_min_vertical_eventoextremo, 2)
    e_min_eventoextremo = params['e_min_eventoextremo'] = round(
        ancho_estribo / 2 - d_min_eventoextremo, 2)
    ...
    esfuerzo_suelo_max_resistencia = params['esfuerzo_suelo_max_resistencia'] = round(
        fuerza_max_vertical_resistencia / (ancho_estribo - 2 * math.fabs(e_max_resistencia))/1000, 2)
    if esfuerzo_suelo_max_resistencia > capacidadportantemayoradadelsuelo:
        print(
            'no cumple verificación de esfuerzos sobre el suelo, estado límite resistencia')

    esfuerzo_suelo_min_resistencia = params['esfuerzo_suelo_min_resistencia'] = round(
        fuerza_min_vertical_resistencia / (ancho_estribo - 2 * math.fabs(e_min_resistencia))/1000, 2)
    if esfuerzo_suelo_min_resistencia > capacidadportantemayoradadelsuelo:
        print(
            'no cumple verificación de esfuerzos sobre el suelo, estado límite resistencia')

    esfuerzo_suelo_max_eventoextremo = params['esfuerzo_suelo_max_eventoextremo'] = round(
        fuerza_max_vertical_eventoextremo / (ancho_estribo - 2 * math.fabs(e_max_eventoextremo))/1000, 2)
    ...
    esfuerzo_suelo_min_eventoextremo = params['esfuerzo_suelo_min_eventoextremo'] = round(
        fuerza_min_vertical_eventoextremo / (ancho_estribo - 2 * math.fabs(e_min_eventoextremo))/1000, 2)
    if esfuerzo_suelo_min_eventoextremo > capacidadportantemayoradadelsuelo_eventoextremo:
        print('no cumple verificación de esfuerzos sobre el suelo, estado límite eventoextremo')

    d_servicio = params['d_servicio'] = round(
        (momento_vertical_servicio - momento_horizontal_servicio)/fuerza_vertical_servicio, 2)
    e_servicio = params['e_servicio'] = round(
        ancho_estribo / 2 - d_servicio, 2)

    esfuerzo_suelo_servicio = params['esfuerzo_suelo_servicio'] = round(
        fuerza_vertical_servicio / (ancho_estribo - 2 * math.fabs(e_servicio))/1000, 2)
    ...
    d_max_resistencia_roca = params['d_max_resistencia_roca'] = (
        momento_max_vertical_resistencia - momento_max_horizontal_resistencia) / fuerza_max_vertical_resistencia
    d_min_resistencia_roca = params['d_min_resistencia_roca'] = (
        momento_min_vertical_resistencia - momento_min_horizontal_resistencia) / fuerza_min_vertical_resistencia

    e_max_resistencia_roca = params['e_max_resistencia_roca'] = (
        ancho_estribo/2 - d_max_resistencia_roca)
    e_min_resistencia_roca = params['e_min_resistencia_roca'] = (
        ancho_estribo/2 - d_min_resistencia_roca)

    if math.fabs(e_max_resistencia_roca) > ancho_estribo/6:
        esfuerzo_suelo_max_resistencia_roca_max = (2 * fuerza_max_vertical_resistencia)/(
            3*ancho_estribo * (ancho_estribo / 2 - e_max_resistencia_roca))
        ...
        esfuerzo_suelo_max_resistencia_roca_max = (
            fuerza_max_vertical_resistencia / ancho_estribo) * (1 + 6 * e_max_resistencia_roca / ancho_estribo)
        esfuerzo_suelo_max_resistencia_roca_min = (
            fuerza_max_vertical_resistencia / ancho_estribo) * (1 - 6 * e_max_resistencia_roca / ancho_estribo)

    if math.fabs(e_min_resistencia_roca) > ancho_estribo/6:
        esfuerzo_suelo_min_resistencia_roca_max = (2 * fuerza_min_vertical_resistencia)/(
            3*ancho_estribo * (ancho_estribo / 2 - e_min_resistencia_roca))
        esfuerzo_suelo_min_resistencia_roca_min = 0

        if math.fabs(e_min_resistencia_roca) > 9 * ancho_estribo / 20:
            print('no cumple ubicación de excentricicdad para esfuerzo sobre roca')
    else:
        esfuerzo_suelo_min_resistencia_roca_max = (
            fuerza_min_vertical_resistencia / ancho_estribo) * (1 + 6 * e_min_resistencia_roca / ancho_estribo)
        esfuerzo_suelo_min_resistencia_roca_min = (
            fuerza_min_vertical_resistencia / ancho_estribo) * (1 - 6 * e_min_resistencia_roca / ancho_estribo)
    ...
    factor_resistencia_cortante_suelo_cimentacion = params['factor_resistencia_cortante_suelo_cimentacion'] = params.get(
        'factor_resistencia_cortante_suelo_cimentacion', 0.8)

    tipo_de_concreto_zapata = params['tipo_de_concreto_zapata'] = params.get(
        'tipo_de_concreto_zapata', 'in situ')
    ...
    resistencia_nominal_desplazamiento_max_resistencia = params['resistencia_nominal_desplazamiento_max_resistencia'] = round(
        fuerza_max_vertical_resistencia * factor_resistencia_cortante_suelo_cimentacion * factor_tipo_concreto_zapata * math.tan(angulodefriccioninternadelsuelodecimentacion/180 * math.pi), 2)
    resistencia_nominal_desplazamiento_min_resistencia = params['resistencia_nominal_desplazamiento_min_resistencia'] = round(
        fuerza_min_vertical_resistencia * factor_resistencia_cortante_suelo_cimentacion * factor_tipo_concreto_zapata * math.tan(angulodefriccioninternadelsuelodecimentacion/180 * math.pi), 2)
    resistencia_nominal_desplazamiento_max_eventoextremo = params['resistencia_nominal_desplazamiento_max_eventoextremo'] = round(
        fuerza_max_vertical_eventoextremo * factor_resistencia_cortante_suelo_cimentacion * factor_tipo_concreto_zapata * math.tan(angulodefriccioninternadelsuelodecimentacion/180 * math.pi), 2)
    resistencia_nominal_desplazamiento_min_eventoextremo = params['resistencia_nominal_desplazamiento_min_eventoextremo'] = round(
        fuerza_min_vertical_eventoextremo * factor_resistencia_cortante_suelo_cimentacion * factor_tipo_concreto_zapata * math.tan(angulodefriccioninternadelsuelodecimentacion/180 * math.pi), 2)
    ...
    EH_vastago = params['EH_vastago'] = round(
        0.5 * coeficiente_presion_activa_suelo * pesoespecifico_suelo * (altura_estribo - altura_base) ** 2, 2)
    Y_vastago_EH = params['Y_vastago_EH'] = round(
        (altura_estribo - altura_base) / 3, 2)
    Y_vastago_pseis = params['Y_vastago_pseis'] = round(
        0.4 * (altura_estribo - altura_base), 2)
    Y_vastago_Hbu = params['Y_vastago_Hbu'] = altura_vastago
    Y_vastago_BR = params['Y_vastago_BR'] = round(altura_vastago + 1.8, 2)
    L_S_y_vastago = params['L_S_y_vastago'] = round(
        presion_horizontal_suelo_sobrecargaviva * (altura_estribo - altura_base), 2)
    Y_vastago_LSy = params['Y_vastago_LSy'] = round(
        (altura_estribo - altura_base)/2, 2)
    M_a_a_EH_vastago = params['M_a_a_EH_vastago'] = round(
        EH_vastago * Y_vastago_EH, 2)
    M_a_a_pseis_vastago = params['M_a_a_pseis_vastago'] = round(
        Pseis_e * Y_vastago_pseis, 2)
    M_a_a_Hbu_vastago = params['M_a_a_Hbu_vastago'] = round(
        Hbu * Y_vastago_Hbu, 2)
    M_a_a_BR_vastago = params['M_a_a_BR_vastago'] = round(
        BR_m_ancho * Y_vastago_BR, 2)
    M_a_a_LSy_vastago = params['M_a_a_LSy_vastago'] = round(
        L_S_y_vastago * Y_vastago_LSy, 2)
    ...
    Mu_vastago_eventoextremo = params['Mu_vastago_eventoextremo'] = round(
        1.5 * M_a_a_EH_vastago + 1 * (M_a_a_pseis_vastago + M_a_a_Hbu_vastago), 2)
    Mu_vastago_resistencia = params['Mu_vastago_resistencia'] = round(
        1.5 * M_a_a_EH_vastago + 1.75 * (M_a_a_LSy_vastago + M_a_a_BR_vastago), 2)
    ...
    cuantia_vastago_flexion = params['cuantia_vastago_flexion'] = round((1-(1-(2 * Mu_vastago_diseño / (
        phi_vastago * 1 * d_vastago ** 2 * 0.85 * fc_estribo * 1000))) ** 0.5) * 0.85 * fc_estribo / fy, 5)
    As_flexion_vastago = params['As_flexion_vastago'] = round(
        cuantia_vastago_flexion * d_vastago * 100 * 100, 2)
    As_8 = params['As_8'] = 5.1
    No_barras_8_flexion_vastago = params['No_barras_8_flexion_vastago'] = round(
        As_flexion_vastago / As_8, 2)
    separacion_flexion_vastago = params['separacion_flexion_vastago'] = round(
        100 / No_barras_8_flexion_vastago)
    ...
    gamma_3_vastago = params['gamma_3_vastago'] = params.get(
        'gamma_3_vastago', 0.75)
    gamma_1_vastago = params['gamma_1_vastago'] = params.get(
        'gamma_1_vastago', 1.6)
    fr_vastago = params['fr_vastago'] = round(0.62 * (fc_estribo)**0.5, 2)
    Sc_vastago = params['Sc_vastago'] = round(1*espesor_vastago ** 2 / 6, 2)
    MCR_vastago = params['MCR_vastago'] = round(
        gamma_3_vastago * (gamma_1_vastago ** 2 * fr_vastago * Sc_vastago)*1000, 2)
    ...
    As_retraccionytemperatura_vastago = params['As_retraccionytemperatura_vastago'] = round(
        750 * altura_vastago * espesor_vastago * 1000 / (2 * (altura_vastago + espesor_vastago) * fy), 2)
    ...
    No_barras_4_retraccionytemperatura_vastago = params['No_barras_4_retraccionytemperatura_vastago'] = math.ceil(
        As_retraccionytemperatura_vastago / 100 / As_4)
    separacion_retraccionytemperatura_vastago = params['separacion_retraccionytemperatura_vastago'] = round(
        100 / No_barras_4_retraccionytemperatura_vastago, 2)
    ...
    gamma_e_vastago = params['gamma_e_vastago'] = params.get(
        'gamma_e_vastago', 1)
    relacionmodular_estribo = params['relacionmodular_estribo'] = round(
        E_acero / (4800 * (fc_estribo) ** 0.5))
    M_servicio_vastago = params['M_servicio_vastago'] = M_a_a_EH_vastago + \
        1 * (M_a_a_BR_vastago + M_a_a_LSy_vastago)
    X_ejecentroidal_vastago = params['X_ejecentroidal_vastago'] = round(- 2 * relacionmodular_estribo * As_flexion_vastago / 10000 + (
        (2 * relacionmodular_estribo * As_flexion_vastago / 10000)**2 - 4 * 1 * -2 * relacionmodular_estribo * As_flexion_vastago / 10000 * d_vastago)**0.5 / (2 * 1), 2)
    I_vastago = params['I_vastago'] = round(1 * X_ejecentroidal_vastago ** 3 / 3 + relacionmodular_estribo *
                                            As_flexion_vastago / 10000 * (d_vastago - X_ejecentroidal_vastago) ** 2, 4)
    fss_vastago = params['fss_vastago'] = round(M_servicio_vastago * (
        d_vastago - X_ejecentroidal_vastago) * relacionmodular_estribo / I_vastago, 2)
    beta_s_vastago = params['beta_s_vastago'] = round(
        1 + (recub_vastago / (0.7 * (espesor_vastago - recub_vastago))), 2)
    separacion_maxima_agrietamiento_vastago = params['separacion_maxima_agrietamiento_vastago'] = round(
        (123000 * gamma_e_vastago / (beta_s_vastago * fss_vastago/1000) - 2 * recub_vastago)/10, 2)
    ...
    Mu_flexion_zarpa_delantera = params['Mu_flexion_zarpa_delantera'] = round(
        esfuerzo_suelo_max_resistencia * 1000 * (ancho_base - espesor_vastago) ** 2 / 2, 2)
    ...
    cuantia_zarpa_delantera_flexion = params['cuantia_zarpa_delantera_flexion'] = round(
        (1-(1-(2 * Mu_diseño_flexion_zarpa_delantera / (phi_zapata * 1 * d_zapata ** 2 * 0.85 * fc_estribo * 1000))) ** 0.5) * 0.85 * fc_estribo / fy, 5)
    As_flexion_zarpa_delantera = params['As_flexion_zarpa_delantera'] = round(
        cuantia_zarpa_delantera_flexion * d_zapata * 100 * 100, 2)
    As_5 = params['As_5'] = 1.99
    No_barras_5_flexion_zarpa_delantera = params['No_barras_5_flexion_zarpa_delantera'] = math.ceil(
        As_flexion_zarpa_delantera / As_5)
    separacion_flexion_zarpa_delantera = params['separacion_flexion_zarpa_delantera'] = round(
        100 / No_barras_5_flexion_zarpa_delantera)
    ...
    Vu_zapata_vastago = params['Vu_zapata_vastago'] = round(
        (ancho_base - espesor_vastago - altura_base) * esfuerzo_suelo_max_resistencia * 1000, 2)
    ...
    Vn_zapata_vastago = params['Vn_zapata_vastago'] = 0.25 * \
        fc_estribo * 1 * d_zapata
    Vc_zapata_vastago = params['Vc_zapata_vastago'] = round(
        0.083 * beta_cortante * (fc_estribo) ** 0.5 * 1 * d_zapata * 1000, 2)
    phi_cortante = params['phi_cortante'] = params.get('phi_cortante', 0.9)
    Vu_cortante_concreto = params['Vu_cortante_concreto'] = phi_cortante * \
        Vc_zapata_vastago
    ...
    Mu_flexion_zarpa_trasera = params['Mu_flexion_zarpa_trasera'] = round(factor_carga_EV_MyE_max * DC_relleno * (X_a_relleno - ancho_base) + factor_carga_DC_max * altura_base * pesoespecifico_concreto * (
        ancho_talon ** 2) / 2 - esfuerzo_suelo_min_resistencia*1000 * (ancho_estribo - 2*e_min_resistencia - ancho_base)**2/2, 2)
    ...
    cuantia_zarpa_trasera_flexion = params['cuantia_zarpa_trasera_flexion'] = round(
        (1-(1-(2 * Mu_diseño_flexion_zarpa_trasera / (phi_zapata * 1 * d_zapata ** 2 * 0.85 * fc_estribo * 1000))) ** 0.5) * 0.85 * fc_estribo / fy, 5)
    As_flexion_zarpa_trasera = params['As_flexion_zarpa_trasera'] = round(
        cuantia_zarpa_trasera_flexion * d_zapata * 100 * 100, 2)
    As_5 = params['As_5'] = 1.99
    No_barras_flexion_zarpa_trasera = params['No_barras_5_flexion_zarpa_trasera'] = math.ceil(
        As_flexion_zarpa_trasera / As_4)
    separacion_flexion_zarpa_trasera = params['separacion_flexion_zarpa_trasera'] = round(
        100 / No_barras_flexion_zarpa_trasera)
    ...
    As_retraccionytemperatura_zapata = params['As_retraccionytemperatura_zapata'] = round(
        750 * ancho_estribo * altura_talon * 1000 / (2 * (ancho_estribo + altura_talon) * fy), 2)
    if As_retraccionytemperatura_vastago < 234 or As_retraccionytemperatura_vastago > 1278:
        print('no cumple armadura por retracción y temperatura')
    As_4 = params['As_4'] = 1.29
    No_barras_4_retraccionytemperatura_zapata = params['No_barras_4_retraccionytemperatura_zapata'] = math.ceil(
        As_retraccionytemperatura_zapata / 100 / As_4)
    separacion_retraccionytemperatura_zapata = params['separacion_retraccionytemperatura_zapata'] = round(
        100 / No_barras_4_retraccionytemperatura_zapata, 2)
...
if __name__ == '__main__':
    ...
    # clasificación sismica del puente
    params['municipio'] = 'Puerto Asís'
    params['departamento'] = 'Putumayo'
    params['PGA'] = 0.15  # región 3
    params['S1'] = 0.20  # región 4
    params['factordesitio'] = 1.6  # S1=0.2, tipo de perfil C
